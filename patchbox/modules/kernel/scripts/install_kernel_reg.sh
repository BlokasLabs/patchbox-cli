...
apt-get update
DEBIAN_FRONTEND=noninteractive apt-get purge blokas-initrd-rt linux-image-rpi-rt-v6 linux-image-rpi-rt-v7 linux-image-rpi-rt-v7l linux-image-rpi-rt-v8 linux-image-rpi-rt-2712
